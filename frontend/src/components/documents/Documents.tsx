...
export function Documents() {
    ...
    const [docType, setDocType] =
        useState<DocumentType>("arsredovisning");

    const [file, setFile] = useState<File | null>(null);

    // Hanterar när användaren väljer en dokumenttyp.
    ...
    // Hanterar när användaren väljer en fil.
    ...
    // Hanterar uppladdning av dokument.
    const handleSubmit = (
    ...
    const handleBack = () => {
        console.log("Tillbaka till ansökan");
    };
    ...
    <section className={styles.formSection}>
        <header>
            <h2>
                Dokument – Ansökan #{applicationId}
            </h2>
        ...
        <div className={styles.documentGrid}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <p className={styles.helpText}>
                                Max 10 MB. Filen sparas men
                                parsas inte automatiskt.
                            </p>
                        </div>
            ...
            <div>
                ...
                <div className={styles.warningAlert}>
                    <strong>OBS:</strong>{" "}
                    PDF-innehåll läses inte automatiskt i v1.
